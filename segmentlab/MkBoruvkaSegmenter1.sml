      ...
      let
        ...
        fun minStarContract (E, seed) = 
            let
              ...
              val PT = mapIdx findSatellites minE
            in
              (PT, newSeed)
            end
        fun MST (P, C, E, T, seed) =
            if length E = 0 then (P, T)
              ...
              let
                ...
                val E' = 
                    filter (fn (u, v, w, l) => nth P' u <> nth P' v) E
                val E'' = 
                    map (fn (u, v, w, l) => (nth P' u, nth P' v, w, l)) E'
        ...
        val (P, T) = 
            MST ((empty()), initialC, labeledE, (empty()), initialSeed)
      in
        (P, T)
      end
end